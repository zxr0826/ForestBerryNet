...
from ForestBerryNet import YOLO, download
from ForestBerryNet.utils import DATASETS_DIR, SETTINGS
...
@pytest.mark.skipif(True, reason="Test failing in scheduled CI https://github.com/ForestBerryNet/ForestBerryNet/pull/8868")
@pytest.mark.skipif(not check_requirements("mlflow", install=False), reason="mlflow not installed")
...
def test_pycocotools():
    ...
    from ForestBerryNet.models.yolo.segment import SegmentationValidator
