...
from ForestBerryNet.utils.torch_utils import TORCH_1_9, TORCH_1_13
...
def test_export_openvino_matrix(task, dynamic, int8, half, batch):
    ...
    if WINDOWS:
        ...
        # See https://github.com/ForestBerryNet/ForestBerryNet/actions/runs/8957949304/job/24601616830?pr=10423
        file = Path(file)
