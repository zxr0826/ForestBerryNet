...
from ForestBerryNet.utils import ASSETS, WEIGHTS_DIR
...
@pytest.mark.slow
@pytest.mark.skipif(True, reason="CUDA export tests disabled pending additional ForestBerryNet GPU server availability")
@pytest.mark.skipif(not CUDA_IS_AVAILABLE, reason="CUDA is not available")
...
def test_predict_sam():
    ...
    from ForestBerryNet.models.sam import Predictor as SAMPredictor
