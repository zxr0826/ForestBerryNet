...
from ForestBerryNet.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding ForestBerryNet classes.

        Returns:
            dict: A dictionary mapping task names to ForestBerryNet task classes for the RT-DETR model.
        """
        return {
            "detect": {
