...
This module provides an interface to the Segment Anything Model (SAM) from ForestBerryNet, designed for real-time image
...
from ForestBerryNet.engine.model import Model
from ForestBerryNet.utils.torch_utils import model_info
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from ForestBerryNet, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': <class 'ForestBerryNet.models.sam.predict.Predictor'>}
        """
