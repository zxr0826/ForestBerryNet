...
using SAM. It forms an integral part of the ForestBerryNet framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from ForestBerryNet.engine.predictor import BasePredictor
from ForestBerryNet.engine.results import Results
from ForestBerryNet.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other ForestBerryNet compatibility settings.
        ...
        # ForestBerryNet compatibility settings
        self.model.pt = False
