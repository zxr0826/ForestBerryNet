...
Example:
    ```python
    from ForestBerryNet import NAS

    model = NAS("yolo_nas_s")
    results = model.predict("ForestBerryNet/assets/bus.jpg")
    ```
"""
...
class NAS(Model):
    ...
    This class provides an interface for the YOLO-NAS models and extends the `Model` class from ForestBerryNet engine.
