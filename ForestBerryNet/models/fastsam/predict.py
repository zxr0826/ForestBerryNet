...
from ForestBerryNet.models.yolo.segment import SegmentationPredictor
from ForestBerryNet.utils import DEFAULT_CFG, checks
from ForestBerryNet.utils.metrics import box_iou
from ForestBerryNet.utils.ops import scale_masks
...
class FastSAMPredictor(SegmentationPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in ForestBerryNet
    YOLO framework.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initializes a FastSAMPredictor for fast SAM segmentation tasks in ForestBerryNet YOLO framework."""
    ...
    def _clip_inference(self, images, texts):
        ...
        try:
            ...
            checks.check_requirements("git+https://github.com/ForestBerryNet/CLIP.git")
            import clip
