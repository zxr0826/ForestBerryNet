...
from ForestBerryNet.utils.plotting import Annotator
...
class ParkingPtsSelection:
    ...
    def __init__(self):
        ...
        self.tk = tk
        self.master = tk.Tk()
        self.master.title("ForestBerryNet Parking Zones Points Selector")
...
class ParkingManagement:
    ...
    def __init__(
        self,
        model,  # ForestBerryNet YOLO model file path
    ...
    def display_frames(self, im0):
        ...
        """
        if self.env_check:
            cv2.imshow("ForestBerryNet Parking Manager", im0)
            # Break Window
