...
from ForestBerryNet.utils import LOGGER, yaml_load
from ForestBerryNet.utils.checks import check_imshow, check_requirements
...
class BaseSolution:
    """A class to manage all the ForestBerryNet Solutions: https://docs.ForestBerryNet.com/solutions/."""
    ...
    def __init__(self, **kwargs):
        ...
        LOGGER.info(f"ForestBerryNet Solutions: ✅ {self.CFG}")
    ...
    def display_output(self, im0):
        ...
        if self.CFG.get("show") and self.env_check:
            cv2.imshow("ForestBerryNet Solutions", im0)
