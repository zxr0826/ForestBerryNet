...
from ForestBerryNet.solutions.solutions import BaseSolution  # Import a parent class
...
class AIGym(BaseSolution):
    ...
    def monitor(self, im0):
        """
        Monitor the workouts using ForestBerryNet YOLOv8 Pose Model: https://docs.ForestBerryNet.com/tasks/pose/.
