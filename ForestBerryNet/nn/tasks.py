...
from ForestBerryNet.nn.modules.CPAEhance import *
from ForestBerryNet.nn.modules.MB import *
from ForestBerryNet.nn.modules.TaylorCPA import *
from ForestBerryNet.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ForestBerryNet.nn.extra_modules import *
from ForestBerryNet.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ForestBerryNet.utils.checks import check_requirements, check_suffix, check_yaml
from ForestBerryNet.utils.loss import (
    E2EDetectLoss,
...
from ForestBerryNet.utils.ops import make_divisible
from ForestBerryNet.utils.plotting import feature_visualization
from ForestBerryNet.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
from ForestBerryNet.nn.backbone.convnextv2 import *
from ForestBerryNet.nn.backbone.fasternet import *
from ForestBerryNet.nn.backbone.efficientViT import *
from ForestBerryNet.nn.backbone.EfficientFormerV2 import *
from ForestBerryNet.nn.backbone.VanillaNet import *
from ForestBerryNet.nn.backbone.revcol import *
from ForestBerryNet.nn.backbone.lsknet import *
from ForestBerryNet.nn.backbone.SwinTransformer import *
from ForestBerryNet.nn.backbone.repvit import *
from ForestBerryNet.nn.backbone.CSwomTramsformer import *
from ForestBerryNet.nn.backbone.UniRepLKNet import *
from ForestBerryNet.nn.backbone.TransNext import *
from ForestBerryNet.nn.backbone.rmt import *
from ForestBerryNet.nn.backbone.pkinet import *
from ForestBerryNet.nn.backbone.mobilenetv4 import *
from ForestBerryNet.nn.backbone.starnet import *
from ForestBerryNet.nn.backbone.inceptionnext import *
from ForestBerryNet.nn.extra_modules.mobileMamba.mobilemamba import *
from ForestBerryNet.nn.backbone.MambaOut import *
...
class BaseModel(nn.Module):
    """The BaseModel class serves as a base class for all the models in the ForestBerryNet YOLO family."""
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ForestBerryNet.models.utils.loss import RTDETRDetectionLoss
...
class WorldModel(DetectionModel):
    ...
    def set_classes(self, text, batch=80, cache_clip_model=True):
        ...
        try:
            ...
            check_requirements("git+https://github.com/ForestBerryNet/CLIP.git")
            import clip
...
def torch_safe_load(weight, safe_only=False):
    ...
    Example:
    ```python
    from ForestBerryNet.nn.tasks import torch_safe_load
    ...
    try:
        with temporary_modules(
            modules={
                "ForestBerryNet.yolo.utils": "ForestBerryNet.utils",
                "ForestBerryNet.yolo.v8": "ForestBerryNet.models.yolo",
                "ForestBerryNet.yolo.data": "ForestBerryNet.data",
            },
            attributes={
                "ForestBerryNet.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ForestBerryNet.nn.tasks.YOLOv10DetectionModel": "ForestBerryNet.nn.tasks.DetectionModel",  # YOLOv10
                "ForestBerryNet.utils.loss.v10DetectLoss": "ForestBerryNet.utils.loss.E2EDetectLoss",  # YOLOv10
            },
        ):
            if safe_only:
        ...
        if e.name == "models":
            raise TypeError(
                emojis(
                    f"ERROR ❌️ {weight} appears to be an ForestBerryNet YOLOv5 model originally trained "
                    f"with https://github.com/ForestBerryNet/yolov5.\nThis model is NOT forwards compatible with "
                    f"YOLOv8 at https://github.com/ForestBerryNet/ForestBerryNet."
                    f"\nRecommend fixes are to train a new model using the latest 'ForestBerryNet' package or to "
                    f"run a command with an official ForestBerryNet model, i.e. 'yolo predict model=yolov8n.pt'"
                )
            ) from e
        LOGGER.warning(
            f"WARNING ⚠️ {weight} appears to require '{e.name}', which is not in ForestBerryNet requirements."
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            LDConv, HCBR, CSP_PMSFA, RFAConv, RFCBAMConv, RFCAConv, CSP_FreqSpatial, C2BRA, C2CGA, C2DA, C2DPB, MANet, MANet_FasterBlock, MANet_FasterCGLU, 
            ...
            if m in ((
                ...
                CSPStage, SPDConv, RepBlock, CSP_EDLAN, RGCSPELAN, CSP_PTB, XSSBlock, HCBR, CSP_PMSFA, CSP_FreqSpatial, C2BRA, C2CGA, C2DA, C2DPB, MANet,
        ...
        elif m in {AIFI, AIFI_RepBN, DTAB, ETB, FDT,CPA_arch,MB_TaylorFormer,TaylorCPA}:
            args = [ch[f], *args]
            c2 = args[0]
...
def yaml_model_load(path):
    ...
    if path.stem in (f"yolov{d}{x}6" for x in "nsmlx" for d in (5, 8)):
        ...
        LOGGER.warning(f"WARNING ⚠️ ForestBerryNet YOLO P6 models now use -p6 suffix. Renaming {path.stem} to {new_stem}.")
