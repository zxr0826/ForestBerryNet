...
from ForestBerryNet.data.augment import Format
from ForestBerryNet.data.dataset import YOLODataset
from ForestBerryNet.data.utils import check_det_dataset
from ForestBerryNet.models.yolo.model import YOLO
from ForestBerryNet.utils import LOGGER, USER_CONFIG_DIR, IterableSimpleNamespace, checks
...
class Explorer:
    ...
    def __init__(
        ...
        # Note duckdb==0.10.0 bug https://github.com/ForestBerryNet/ForestBerryNet/pull/8181
    ...
    def query(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.query(img="https://ForestBerryNet.com/images/zidane.jpg")
            ```
        """
    ...
    def get_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.get_similar(img="https://ForestBerryNet.com/images/zidane.jpg")
            ```
        """
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.plot_similar(img="https://ForestBerryNet.com/images/zidane.jpg")
            ```
        """
