...
from ForestBerryNet import Explorer
from ForestBerryNet.utils import ROOT, SETTINGS
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        st.image(
            "https://raw.githubusercontent.com/ForestBerryNet/assets/main/logo/ForestBerryNet_Logotype_Original.svg",
            width=100,
        )
        st.markdown(
            "<p>This demo is built using ForestBerryNet Explorer API. Visit <a href='https://docs.ForestBerryNet.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.ForestBerryNet.com/datasets/explorer/")


def layout(data=None, model=None):
    """Resets explorer session variables and provides documentation with a link to API docs."""
    st.set_page_config(layout="wide", initial_sidebar_state="collapsed")
    st.markdown("<h1 style='text-align: center;'>ForestBerryNet Explorer Demo</h1>", unsafe_allow_html=True)
