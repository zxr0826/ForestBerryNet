...
from ForestBerryNet.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def get_image_and_label(self, index):
        ...
        label = deepcopy(self.labels[index])  # requires deepcopy() https://github.com/ForestBerryNet/ForestBerryNet/pull/1948
