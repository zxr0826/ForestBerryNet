...
from ForestBerryNet.data.utils import polygons2masks, polygons2masks_overlap
from ForestBerryNet.utils import LOGGER, colorstr
from ForestBerryNet.utils.checks import check_version
from ForestBerryNet.utils.instance import Instances
from ForestBerryNet.utils.metrics import bbox_ioa
from ForestBerryNet.utils.ops import segment2box, xyxyxyxy2xywhr
from ForestBerryNet.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class BaseTransform:
    """
    Base class for image transformations in the ForestBerryNet library.
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ForestBerryNet.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ForestBerryNet.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ForestBerryNet.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        values and labels. This implementation is designed for use with the ForestBerryNet YOLO framework.
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ForestBerryNet.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (ForestBerryNet.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (ForestBerryNet.utils.instance.Instances): Updated instances matching the flipped image.
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ForestBerryNet.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import ForestBerryNet'
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        ForestBerryNet YOLO framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
