...
Requirements:
    $ pip install "ForestBerryNet[export]"
...
from ForestBerryNet.cfg import TASK2DATA, get_cfg
from ForestBerryNet.data import build_dataloader
from ForestBerryNet.data.dataset import YOLODataset
from ForestBerryNet.data.utils import check_cls_dataset, check_det_dataset
from ForestBerryNet.nn.autobackend import check_class_names, default_class_names
from ForestBerryNet.nn.modules import C2f, Detect, RTDETRDecoder
from ForestBerryNet.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from ForestBerryNet.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from ForestBerryNet.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ForestBerryNet.utils.files import file_size, spaces_in_path
from ForestBerryNet.utils.ops import Profile
from ForestBerryNet.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode


def export_formats():
    """ForestBerryNet YOLO export formats."""
    x = [
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/ForestBerryNet/ForestBerryNet/pull/13420
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.ForestBerryNet.com/models/yolo-world for details."
            )
        ...
        description = f'ForestBerryNet {self.pretty_name} model {f"trained on {data}" if data else ""}'
        self.metadata = {
            "description": description,
            "author": "ForestBerryNet",
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before TRT import https://github.com/ForestBerryNet/ForestBerryNet/issues/7016
        ...
        check_version(trt.__version__, "<=10.1.0", msg="https://github.com/ForestBerryNet/ForestBerryNet/pull/14239")
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # ForestBerryNet.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/ForestBerryNet/ForestBerryNet/issues/5161",
        )
        import onnx2tf
    ...
    def export_tflite(self, keras_model, nms, agnostic_nms, prefix=colorstr("TensorFlow Lite:")):
        ...
        # BUG https://github.com/ForestBerryNet/ForestBerryNet/issues/13436
        import tensorflow as tf  # noqa
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/ForestBerryNet/ForestBerryNet/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an ForestBerryNet YOLO model for Apple iOS CoreML export."""
