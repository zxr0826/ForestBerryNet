...
from ForestBerryNet.cfg import TASK2DATA, get_cfg, get_save_dir
from ForestBerryNet.engine.results import Results
from ForestBerryNet.hub import HUB_WEB_ROOT, HUBTrainingSession
from ForestBerryNet.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ForestBerryNet.utils import (
    ARGV,
    ASSETS,
    DEFAULT_CFG_DICT,
    LOGGER,
...
class Model(nn.Module):
    ...
    loaded from local files, ForestBerryNet HUB, or Triton Server.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The ForestBerryNet HUB session, if applicable.
    ...
    def __init__(
        ...
        model sources, including local files, ForestBerryNet HUB models, and Triton Server models. The method
        ...
        Args:
            model (Union[str, Path]): Path or name of the model to load or create. Can be a local file path, a
                model name from ForestBerryNet HUB, or a Triton Server model.
        ...
        # Check if ForestBerryNet HUB model from https://hub.ForestBerryNet.com
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ForestBerryNet.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.

        Examples:
            >>> model = YOLO("yolov8n.pt")
            >>> results = model("https://ForestBerryNet.com/images/bus.jpg")
            >>> for r in results:
    ...
    def is_hub_model(model: str) -> bool:
        """
        Check if the provided model is an ForestBerryNet HUB model.

        This static method determines whether the given model string represents a valid ForestBerryNet HUB model
        identifier.
        ...
        Returns:
            (bool): True if the model is a valid ForestBerryNet HUB model, False otherwise.

        Examples:
            >>> Model.is_hub_model("https://hub.ForestBerryNet.com/models/MODEL")
            True
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        the date, ForestBerryNet version, license information, and a link to the documentation.
        ...
        from ForestBerryNet import __version__

        updates = {
            "model": deepcopy(self.model).half() if isinstance(self.model, nn.Module) else self.model,
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://ForestBerryNet.com/license)",
            "docs": "https://docs.ForestBerryNet.com",
        }
    ...
    def embed(
        ...
        **kwargs,
        ...
        Examples:
            >>> model = YOLO("yolov8n.pt")
            >>> image = "https://ForestBerryNet.com/images/bus.jpg"
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("ForestBerryNet")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ForestBerryNet.engine.results.Results]): A list of tracking results, each a Results object.
        ...
        if not hasattr(self.predictor, "trackers"):
            from ForestBerryNet.trackers import register_tracker
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (ForestBerryNet.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (ForestBerryNet.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the ForestBerryNet.utils.benchmarks module. The benchmarking is
        ...
        """
        self._check_is_pytorch_model()
        from ForestBerryNet.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs,
        ...
        from a checkpoint, integrating with ForestBerryNet HUB, and updating model and configuration after training.

        When using ForestBerryNet HUB, if the session has a loaded model, the method prioritizes HUB training
        ...
        """
        self._check_is_pytorch_model()
        if hasattr(self.session, "model") and self.session.model.id:  # ForestBerryNet HUB session with loaded model
            if any(kwargs):
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ForestBerryNet.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ForestBerryNet.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the ForestBerryNet.nn.autobackend module. If the predictor is not
        ...
        """
        from ForestBerryNet.nn.autobackend import check_class_names
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Args:
            event (str): The name of the event to attach the callback to. Must be a valid event name recognized
                by the ForestBerryNet framework.
    ...
    def clear_callback(self, event: str) -> None:
        ...
        Args:
            event (str): The name of the event for which to clear the callbacks. This should be a valid event name
                recognized by the ForestBerryNet callback system.
        ...
        Notes:
            - This method affects both custom callbacks added by the user and default callbacks
              provided by the ForestBerryNet framework.
    ...
    def task_map(self) -> dict:
        ...
        various tasks and modes within the ForestBerryNet framework.
        ...
        Note:
            ...
            classes supported by the ForestBerryNet framework. The docstring provides a general
