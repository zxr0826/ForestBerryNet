...
from ForestBerryNet.utils.metrics import OKS_SIGMA
from ForestBerryNet.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from ForestBerryNet.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
from ForestBerryNet.utils.atss import ATSSAssigner, generate_anchors
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.ForestBerryNet.com/datasets/segment/ for help."
            ) from e
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.ForestBerryNet.com/datasets/obb/ for help."
            ) from e
