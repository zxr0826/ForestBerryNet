...
def spaces_in_path(path):
    ...
    Examples:
        ...
        >>> from ForestBerryNet.utils.files import spaces_in_path
...
def update_models(model_names=("yolov8n.pt",), source_dir=Path("."), update_names=False):
    ...
    Examples:
        ...
        >>> from ForestBerryNet.utils.files import update_models
        >>> model_names = ("yolov8n.pt", "yolov8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from ForestBerryNet import YOLO
    from ForestBerryNet.nn.autobackend import default_class_names
