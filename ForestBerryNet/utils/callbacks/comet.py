...
from ForestBerryNet.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
...
try:
    ...
    # Names of plots created by ForestBerryNet that are logged to Comet
...
def _get_comet_model_name():
    """Returns the model name for Comet from the environment variable COMET_MODEL_NAME or defaults to 'ForestBerryNet'."""
    return os.getenv("COMET_MODEL_NAME", "ForestBerryNet")
