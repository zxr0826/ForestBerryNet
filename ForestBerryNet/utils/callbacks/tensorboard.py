...
from ForestBerryNet.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/ForestBerryNet/ForestBerryNet/pull/4674
    ...
    from ForestBerryNet.utils.torch_utils import de_parallel, torch
