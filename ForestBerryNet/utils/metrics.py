...
from ForestBerryNet.utils import LOGGER, SimpleClass, TryExcept, plt_settings
...
def smooth_BCE(eps=0.1):
    ...
    For implementation details, refer to https://github.com/ForestBerryNet/yolov3/issues/238#issuecomment-598028441.
