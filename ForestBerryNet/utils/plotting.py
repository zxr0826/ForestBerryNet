...
from ForestBerryNet.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from ForestBerryNet.utils.checks import check_font, check_version, is_ascii
from ForestBerryNet.utils.files import increment_path


class Colors:
    """
    ForestBerryNet color palette https://docs.ForestBerryNet.com/reference/utils/plotting/#ForestBerryNet.utils.plotting.Colors.

    This class provides methods to work with the ForestBerryNet color palette, including converting hex color codes to
    RGB values.
    ...
    !!! note "ForestBerryNet Brand Colors"

        For ForestBerryNet brand colors see [https://www.ForestBerryNet.com/brand](https://www.ForestBerryNet.com/brand). Please use the official ForestBerryNet colors for all marketing materials.
    """
...
class Annotator:
    """
    ForestBerryNet Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/ForestBerryNet/yolov5/issues/5395
@plt_settings()
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels including class histograms and box statistics."""
    import pandas  # scope for faster 'import ForestBerryNet'
    import seaborn  # scope for faster 'import ForestBerryNet'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from ForestBerryNet.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/ForestBerryNet/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from ForestBerryNet.utils.plotting import plot_results

        plot_results("path/to/results.csv", segment=True)
        ```
    """
    import pandas as pd  # scope for faster 'import ForestBerryNet'
